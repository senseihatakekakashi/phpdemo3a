<?php
    ...
    if(isset($_POST['update']) && $_POST['id'] && $_POST['size'] && $_POST['quantity']) {
        $arr_id = $_POST['id'];
        $arr_size = $_POST['size'];
        ...
        foreach($arr_id as $index => $value_id) {
            ...
            $_SESSION['total_count'] += $arr_quantity[$index];
        }
    }
?>
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-2 text-right">
                ...
                <i class="fa fa-shopping-cart"></i> Cart <span class="badge badge-light"><?php echo $_SESSION['total_count']; ?></span>
                </a>
            </div>
            <div class="col-12">
                <hr>
                        ...
                        <tbody>                            
                            <?php if(isset($_SESSION['cart'])): ?>                            
                                <?php foreach($_SESSION['cart'] as $id => $sizes): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php endforeach; ?>
                                <?php if(!empty($_SESSION['cart'][0])): ?>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td><b>Total</b></td>
                                        <td class="text-center"><?php echo $_SESSION['total_count']; ?></td>
